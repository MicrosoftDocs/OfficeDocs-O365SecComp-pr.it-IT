...
In questo argomento vengono descritti i passaggi da seguire per poter attivare e quindi impostare backup Azure Rights Management (RMS), parte di Azure Information Protection per l'utilizzo con la versione precedente di Office 365 messaggio crittografia (OME).

## <a name="this-article-only-applies-to-the-previous-version-of-ome"></a>In questo articolo si applica solo alla versione precedente di OME
