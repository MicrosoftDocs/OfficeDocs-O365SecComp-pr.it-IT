---
title: "crittografia della posta elettronica in Office 365" ms. Author: Krowley Author: kccross Manager: laurawi ms. Date: 10/30/2018 ms. audience: admin ms. Topic: Overview ms. Service: O365-Administration localization_priority: Normal search. appverid: 
- MOE150
- MET150 ms. AssetID: c0d87cbe-6d65-4c03-88ad-5216ea5564e8 ms. Collection:
    - M365-Security-Compliance Description: "confrontare le opzioni di crittografia in Office 365, tra cui la crittografia dei messaggi di Office (OME), S/MIME, Information Rights Management (IRM) e informazioni su TLS (Transport Layer Security)".
---
...
Office 365 offre più opzioni di crittografia per soddisfare le esigenze aziendali relative alla sicurezza della posta elettronica. In questo articolo vengono illustrati tre modi per crittografare la posta elettronica in Office 365. Se si desiderano ulteriori informazioni su tutte le funzionalità di sicurezza di Office 365, visitare il Centro protezione di [office 365](http://go.microsoft.com/fwlink/p/?LinkID=282470). In questo articolo vengono introdotti i tre tipi di crittografia disponibili per gli amministratori di Office 365 che consentono di proteggere la posta elettronica in Office 365:
...
La crittografia è il processo con cui le informazioni vengono codificate in modo che solo un destinatario autorizzato sia in grado di decodificarle e utilizzarle. Office 365 utilizza la crittografia in due modi: nel servizio e come controllo del cliente. Nel servizio, la crittografia viene utilizzata in Office 365 per impostazione predefinita. non è necessario configurare nulla. Ad esempio, Office 365 utilizza Transport Layer Security (TLS) per crittografare la connessione o la sessione tra due server. 
...
"Data at rest" si riferisce a dati che non sono attivamente in transito. In Office 365, i dati statici della posta elettronica vengono crittografati utilizzando Crittografia unità BitLocker. BitLocker consente di crittografare i dischi rigidi nei data center di Office 365 per fornire protezione avanzata da accessi non autorizzati. Per ulteriori informazioni, vedere [Panoramica su BitLocker](https://go.microsoft.com/fwlink/p/?LinkId=394737).
