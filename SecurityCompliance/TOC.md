...
## [Guida di orientamento per il centro di sicurezza di Office 365](security-roadmap.md)
...
## [Usare la Finestra esplora nel Centro sicurezza e conformità](use-explorer-in-security-and-compliance.md)
...
## [Scegliere tra Gestione dispositivi mobili esterni e Intune](choose-between-mdm-and-intune.md)
...
### [Usare le notifiche e i suggerimenti per i criteri nei criteri DLP](use-notifications-and-policy-tips.md)
...
### [Creare una query per individuare i dati riservati memorizzati nei siti](form-a-query-to-find-sensitive-data-stored-on-sites.md)
...
## Usare i tipi di informazioni riservate
...
# Gestione della governance dei dati        
## [Importare dati](importing-pst-files-to-office-365.md)
### [Usare il caricamento di rete per importare la posta elettronica (file PST)](use-network-upload-to-import-pst-files.md)
### [Usare la spedizione unità per importare la posta elettronica (file PST)](use-drive-shipping-to-import-pst-files-to-office-365.md)
...
### [Come evitare che la posta elettronica realmente esistente venga contrassegnata come indesiderata in Office 365 ](prevent-email-from-being-marked-as-spam.md)
...
### [ZAP: protezione contro la posta indesiderata e malware](zero-hour-auto-purge.md)
...
### [Configurare le nuove funzionalità di crittografia dei messaggi di Office 365](set-up-new-message-encryption-capabilities.md)
...
### [Domande frequenti sulla crittografia del servizio con Chiave cliente per Office 365](service-encryption-with-customer-key-faq.md)
...
### [Controllare i dati in Office 365 tramite la Chiave cliente](controlling-your-data-using-customer-key.md)
### [Dettagli tecnici di riferimento sulla crittografia in Office 365](technical-reference-details-about-encryption.md)
### [Come viene utilizzato il TLS (Transport Layer Security) per proteggere il traffico della posta elettronica in Office 365](exchange-online-uses-tls-to-secure-email-connections.md)
### [Domande frequenti sulla crittografia dei messaggi di Office 365](ome-faq.md)
### [Informazioni di natura legacy per la crittografia dei messaggi di Office 365](legacy-information-for-message-encryption.md)
### [Informativa sulla privacy del Portale dei messaggi protetti in Office 365](protected-message-viewer-portal-privacy-statement.md)
### [Creare le condizioni per un criterio del processo di revisione](create-conditions-for-a-supervisory-review-policy.md)
### [Configurare Microsoft Azure AD Rights Management per la crittografia dei messaggi di Office 365](set-up-azure-rm-for-message-encryption.md)
...
#### [Pagine di avviso dei collegamenti sicuri ATP](atp-safe-links-warning-pages.md)
#### [Configurare un elenco personalizzato di URL “non riscrivere”](set-up-a-custom-do-not-rewrite-urls-list-with-atp.md)
#### [Configurare un elenco personalizzato di URL bloccati](set-up-a-custom-blocked-urls-list-wtih-atp.md)
### [Allegati sicuri ATP](atp-safe-attachments.md)
...
### [Registrazioni di minaccia, nuove e importanti](threat-trackers.md)
...
### [Il log del traffico web e origini dati per Office 365 Cloud App Security](web-traffic-logs-and-data-sources-for-ocas.md)
### [Sospendere o ripristinare un account utente in Office 365 Cloud App Security](suspend-or-restore-an-account-in-ocas.md)
### [Creare i rapporti di App Discovery con Office 365 Cloud App Security](create-app-discovery-reports-in-ocas.md)
...
## [Serie di soluzioni eDiscovery, scenario di perdita di dati, ricerca ed eliminazione](data-spillage-scenariosearch-and-purge.md)
...
### [Aumentare la quota degli Elementi recuperabili per le cassette postali bloccate](increase-the-recoverable-quota-for-mailboxes-on-hold.md)
### [Come identificare il tipo di blocco applicato su una cassetta postale di Exchange Online](identify-a-hold-on-an-exchange-online-mailbox.md)
...
### [Analizzare i dati del caso con Office 365 Advanced eDiscovery](analyze-case-data-with-advanced-ediscovery.md)
### [Esportare i dati del caso in Office 365 Advanced eDiscovery](export-case-data-in-advanced-ediscovery.md)
### [Usare le utilità di Office 365 Advanced eDiscovery](use-advanced-ediscovery-utilities.md)
### [I ruoli utente e accesso in Office 365 Advanced eDiscovery](user-roles-and-access-in-advanced-ediscovery.md)
...
### [Prepara i dati per Office 365 Advanced eDiscovery](prepare-data-for-advanced-ediscovery.md)
### [Esportare i campi rapporto in Office 365 Advanced eDiscovery](export-report-fields-in-advanced-ediscovery.md)
...
### [Visualizzare la cronologia in batch ed esportare i risultati precedenti in Office 365 Advanced eDiscovery ](view-batch-history-and-export-past-results.md)
...
### [Tener traccia dell’analisi di Rilevanza in Office 365 Advanced eDiscovery](track-relevance-analysis-in-advanced-ediscovery.md)
### [Decisione basata sui risultati in Office 365 Advanced eDiscovery](decision-based-on-the-results-in-advanced-ediscovery.md)
...
### [Regola le impostazioni avanzate di Analizza in Office 365 Advanced eDiscovery](set-analyze-options-in-advanced-ediscovery.md)
### [Informazioni sulla valutazione in Rilevanza di Office 365 Advanced eDiscovery](assessment-in-relevance-in-advanced-ediscovery.md)
...
## [I rapporti e gli approfondimenti intelligenti nel Centro sicurezza e conformità](reports-and-insights-in-security-and-compliance.md)
...
## [Attivare il componente aggiuntivo Report Message](enable-the-report-message-add-in.md)

# Soluzioni di sicurezza
## [Guida sulla sicurezza di Microsoft per campagne politiche, non profit e altre organizzazioni imprenditoriali](https://docs.microsoft.com/Office365/Enterprise/microsoft-security-guidance-for-political-campaigns-nonprofits-and-other-agile-o)
...
## [Utilizzare il Gestore conformità in modo da soddisfare i requisiti normativi e la protezione dei dati quando si utilizzano i servizi cloud Microsoft](meet-data-protection-and-regulatory-reqs-using-microsoft-cloud.md)
## [Gestire le richieste sulla questione del GDPR con lo strumento distinzione DSR](manage-gdpr-data-subject-requests-with-the-dsr-case-tool.md)
...
### [Panoramica: protezione di Office 365 per GDPR](https://docs.microsoft.com/Office365/Enterprise/office-365-info-protection-for-gdpr-overview)
### [Cercare e trovare i dati personali](https://docs.microsoft.com/Office365/Enterprise/search-for-and-find-personal-data)
### [Personalizzare o creare nuovi tipi di informazioni riservate per GDPR](https://docs.microsoft.com/Office365/Enterprise/customize-or-create-a-new-sensitive-information-type)
...
## [Rilevare e rimediare a concessioni di consenso illecite in Office 365](https://docs.microsoft.com/Office365/Enterprise/detect-and-remediate-illicit-consent-grants)
## [Rilevare e correggere le regole di Outlook e injections nei moduli personalizzati in Office 365](https://docs.microsoft.com/Office365/Enterprise/detect-and-remediate-outlook-rules-forms-attack)
...
## [Capacità di recupero dei dati in Office 365](office-365-data-resiliency-overview.md)
### [Gestione della corruzione dei dati](office-365-dealing-with-data-corruption.md)
### [Capacità di recupero dei dati di Exchange Online](office-365-exchange-data-resiliency.md)
...
### [Capacità di recupero dei dati di SharePoint Online](office-365-sharepoint-data-resiliency.md)
## [Conservazione dei dati, eliminazione e distruzione in Office 365](office-365-data-retention-deletion-and-destruction-overview.md)
### [Distruzione dei dati](office-365-data-destruction.md)
### [Non modificabilità in Office 365](office-365-data-immutability.md)
...
### [Controlli per tecnologia di Office 365](office-365-technology-controls.md)
...
### [Strategia di protezione di Denial of Service di Microsoft](office-365-microsoft-dos-defense-strategy.md)
...
#### [Gestire gli elenchi di mittenti attendibili per spedizioni in blocco](manage-safe-sender-lists-for-bulk-mailers.md)
...
### [Creare elenchi di mittenti attendibili per l’intera organizzazione o elenchi di mittenti bloccati in Office 365](create-organization-wide-safe-sender-or-blocked-sender-lists-in-office-365.md)
...
### [Utilizzare DKIM (DomainKeys Identified Mail) per convalidare la posta elettronica in uscita](use-dkim-to-validate-outbound-email.md)
...
### [Informazioni sulla gestione dei diritti in Exchange Online](information-rights-management-in-exchange-online.md)
### [Configurazione di IRM per l'utilizzo di un server AD RMS locale](configure-irm-to-use-an-on-premises-ad-rms-server.md)
## [Criteri e conformità messaggistica in EOP](eop/messaging-policy-and-compliance-in-eop.md)
### [Report di controllo in EOP](eop/auditing-reports-in-eop.md)
### [Esecuzione del report di un gruppo di ruoli amministratore in EOP](eop/run-an-administrator-role-group-report-in-eop-eop.md)
...
### [Gestione delle autorizzazioni del gruppo di ruoli di amministratore in EOP](eop/manage-admin-role-group-permissions-in-eop.md)
...
### [Creazione di rapporti e traccia dei messaggi](eop/reporting-and-message-trace-in-exchange-online-protection.md)
...
### [Conservazione in caso di dispute di una cassetta postale](place-a-mailbox-on-litigation-hold.md)
...
### [Inserire un blocco sul posto di una cassetta postale reversibile](put-an-in-place-hold-on-a-soft-deleted-mailbox.md)
...
### [Configurazione delle impostazioni S/MIME per Outlook Web App](configure-s-mime-settings-for-outlook-web-app.md)
### [Invio e ricezione di posta elettronica crittografata e firmata tramite S/MIME](send-and-receive-s-mime-signed-and-encrypted-email.md)
### [Sincronizzare i certificati dell'utente con Office 365 per S/MIME](sync-user-certificates-to-office-365-for-s-mime.md)
### [Configurazione della raccolta di certificati virtuali per convalidare S/MIME](set-up-virtual-certificate-collection-to-validate-s-mime.md)
...
### [Accesso facilitato per persone con disabilità](eop/accessibility-for-people-with-disabilities.md)
### [L'invio di posta elettronica a Office 365](sending-mail-to-office-365.md)
### [Servizi per i potenziali clienti](services-for-non-customers.md)
