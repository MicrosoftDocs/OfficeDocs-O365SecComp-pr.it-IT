...
6. Nel riquadro **Denomina l'etichetta **, digitare il nome dell’etichetta e fare clic su **Avanti**.
...
1. Dal riquadro **Home > Etichette** del Centro sicurezza e conformità, fare clic su **Pubblica etichette**.
...
17. Nel riquadro **Quale operazione eseguire se vengono rilevate informazioni riservate?**, selezionare l’opzione per **richiedere motivazioni aziendali per eseguire l'override**, quindi fare clic su **Avanti**.
