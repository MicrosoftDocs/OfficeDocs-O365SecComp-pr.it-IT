...
Si noti che gli elementi nella cartella elementi ripristinabili nella cassetta postale di archivio principale dell'utente verranno eliminati anche quando si esegue il cmdlet **Search-Mailbox** . Per evitare questo problema, è possibile includere l'opzione *DoNotIncludeArchive* . E come descritto in precedenza, se l'archiviazione l'espansione automatica è abilitata per la cassetta postale di * * Search-Mailbox * * cmdlet non elementi eliminati in una cassetta postale di archivio ausiliaria. Per ulteriori informazioni sull'espansione automatica archiviazione, vedere [Overview of archiviazione illimitato in Office 365](unlimited-archiving.md).
