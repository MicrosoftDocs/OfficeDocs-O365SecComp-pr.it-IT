...
### <a name="supported-siem-servers"></a><span data-ttu-id="f1fd2-127">Server SIEM supportati</span><span class="sxs-lookup"><span data-stu-id="f1fd2-127">Supported SIEM servers</span></span>
...
4. <span data-ttu-id="f1fd2-152">Scegliere **Avvia procedura guidata**.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-152">Choose **Start wizard**.</span></span><br/><span data-ttu-id="f1fd2-153">![Ottenere assistenza o avviare la procedura guidata](media/HelpOrWizard.png)</span><span class="sxs-lookup"><span data-stu-id="f1fd2-153">![Get help or start the wizard](media/HelpOrWizard.png)</span></span> 
    
5. <span data-ttu-id="f1fd2-154">Nel passaggio **generale** , specificare un nome, quindi **selezionare il formato Siem** e impostare le **Impostazioni avanzate** rilevanti per tale formato.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-154">In the **General** step, specify a name, and **Select your SIEM format** and set any **Advanced settings** that are relevant to that format.</span></span> <span data-ttu-id="f1fd2-155">Fare quindi clic su **Avanti**.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-155">Then choose **Next**.</span></span><br/><span data-ttu-id="f1fd2-156">![Specificare un nome e un tipo](media/ChooseAgentTypeAndName.png)</span><span class="sxs-lookup"><span data-stu-id="f1fd2-156">![Specify a name and type](media/ChooseAgentTypeAndName.png)</span></span>
    
6. <span data-ttu-id="f1fd2-157">Nel passaggio **syslog Remote** , specificare l'indirizzo IP o il nome host dell' **host syslog remoto** e il **numero di porta syslog**.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-157">In the **Remote Syslog** step, specify the IP address or hostname of the **Remote syslog host** and the **Syslog port number**.</span></span> <span data-ttu-id="f1fd2-158">Selezionare TCP o UDP come protocollo syslog remoto.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-158">Select TCP or UDP as the Remote Syslog protocol.</span></span> <span data-ttu-id="f1fd2-159">Se non si dispone di tali informazioni, è possibile collaborare con l'amministratore di rete o con l'amministratore della sicurezza. Fare quindi clic su **Avanti**.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-159">(You can work with your network administrator or security administrator to get these details if you don't have them.) Then choose **Next**.</span></span><br/><span data-ttu-id="f1fd2-160">![Specificare i dettagli di syslog remoti](media/ArcSightS1Syslog.png)</span><span class="sxs-lookup"><span data-stu-id="f1fd2-160">![Specify Remote Syslog details](media/ArcSightS1Syslog.png)</span></span>
  
7. <span data-ttu-id="f1fd2-161">Nel passaggio **tipi di dati** effettuare una delle operazioni seguenti e quindi fare clic su **Avanti**:</span><span class="sxs-lookup"><span data-stu-id="f1fd2-161">In the **Data Types** step, do one of the following, and then click **Next**:</span></span>
...
2. <span data-ttu-id="f1fd2-177">Estrarre il file. jar dalla cartella zippata ed eseguirlo sul server SIEM.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-177">Extract the .jar file from the zipped folder and run it on your SIEM server.</span></span>
...
- <span data-ttu-id="f1fd2-185">I parametri tra parentesi quadre [] sono facoltativi e devono essere utilizzati solo se rilevanti.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-185">Parameters in brackets [] are optional, and should be used only if relevant.</span></span> <span data-ttu-id="f1fd2-186">Utilizzare le seguenti variabili:</span><span class="sxs-lookup"><span data-stu-id="f1fd2-186">Use the following variables:</span></span>
    ...
    - <span data-ttu-id="f1fd2-189">**Token** è il token dell'agente Siem copiato nella prima procedura.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-189">**TOKEN** is the SIEM agent token you copied in the first procedure.</span></span>

    - <span data-ttu-id="f1fd2-190">Per ottenere assistenza, digitare `-h`.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-190">To get help, type `-h`.</span></span> 
  
## <a name="step-3-validate-that-the-siem-agent-is-working"></a><span data-ttu-id="f1fd2-191">Passaggio 3: verificare che l'agente SIEM funzioni</span><span class="sxs-lookup"><span data-stu-id="f1fd2-191">Step 3: Validate that the SIEM agent is working</span></span>

1. <span data-ttu-id="f1fd2-192">Verificare che lo stato dell'agente SIEM nel portale di sicurezza delle app cloud di Office 365 non venga visualizzato come **errore di connessione** o disconnesso e che non vi siano notifiche di agente. \*\*\*\*</span><span class="sxs-lookup"><span data-stu-id="f1fd2-192">Make sure the status of the SIEM agent in the Office 365 Cloud App Security portal is not displayed as **Connection error** or **Disconnected** and that there are no agent notifications.</span></span><br/><span data-ttu-id="f1fd2-193">Ad esempio, qui è possibile vedere che il server SIEM è connesso:</span><span class="sxs-lookup"><span data-stu-id="f1fd2-193">For example, here we can see the SIEM server is connected:</span></span><br/><span data-ttu-id="f1fd2-194">![Server SIEM connesso](media/siem-connected.png)</span><span class="sxs-lookup"><span data-stu-id="f1fd2-194">![SIEM server connected](media/siem-connected.png)</span></span><br/><span data-ttu-id="f1fd2-195">E qui, è possibile vedere il server SIEM è disconnesso:</span><span class="sxs-lookup"><span data-stu-id="f1fd2-195">And here, we can see the SIEM server is disconnected:</span></span><br/><span data-ttu-id="f1fd2-196">![Server SIEM non connesso](media/siem-not-connected.png)</span><span class="sxs-lookup"><span data-stu-id="f1fd2-196">![SIEM server not connected](media/siem-not-connected.png)</span></span> 
  
2. <span data-ttu-id="f1fd2-197">Nel server syslog/SIEM, verificare che gli avvisi siano arrivati da Office 365 cloud app Security.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-197">In your Syslog/SIEM server, make sure you see that alerts have arrived from Office 365 Cloud App Security.</span></span>
  
## <a name="what-the-logfiles-look-like"></a><span data-ttu-id="f1fd2-198">Aspetto dei file di log</span><span class="sxs-lookup"><span data-stu-id="f1fd2-198">What the logfiles look like</span></span>

<span data-ttu-id="f1fd2-199">Di seguito è riportato un esempio di file di log avvisi che potrebbe essere inviato a un server SIEM:</span><span class="sxs-lookup"><span data-stu-id="f1fd2-199">Here's an alerts logfile example that might be sent to a SIEM server:</span></span>
...
## <a name="additional-tasks-as-needed"></a><span data-ttu-id="f1fd2-220">Altre attività (se necessario)</span><span class="sxs-lookup"><span data-stu-id="f1fd2-220">Additional tasks (as needed)</span></span>
...
1. <span data-ttu-id="f1fd2-230">In Office 365 Cloud App security[https://portal.cloudappsecurity.com](https://portal.cloudappsecurity.com)portal (), scegliere **Settings** > **security extensions**.</span><span class="sxs-lookup"><span data-stu-id="f1fd2-230">In the Office 365 Cloud App Security portal ([https://portal.cloudappsecurity.com](https://portal.cloudappsecurity.com)), choose **Settings** > **Security extensions**.</span></span>
