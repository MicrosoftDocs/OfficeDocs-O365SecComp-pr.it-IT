...
Queste attività in modo rapido e hanno un impatto minimo per gli utenti.
...
|Informazioni proteciton  <br/> | Esaminare i suggerimenti di protezione informazioni di esempio. Protezione delle informazioni richiede il coordinamento all'interno dell'organizzazione. Introduzione a queste risorse:<br/> • [Protezione di office 365 informazioni per PILR](http://aka.ms/o365gdpr) <br/> • [File e siti di SharePoint Online sicura](https://docs.microsoft.com/Office365/enterprise/secure-sharepoint-online-sites-and-files) (include la condivisione, classificazione, prevenzione della perdita di dati e la protezione delle informazioni di Azure)  <br/> |
   
## <a name="90-days--enhanced-protections"></a>90 giorni, ovvero avanzata protezioni
<a name="Ninetydays"> </a>

Queste attività un po' di tempo maggiore pianificare e implementare ma aumentare notevolmente le condizioni di sicurezza generali. 
...
|Informazioni proteciton  <br/> | • Affina ricerca criteri e i processi operativi.  <br/>  • Utilizzare la protezione dell'identità di Azure Active Directory per identificare le minacce dal.  <br/> |
