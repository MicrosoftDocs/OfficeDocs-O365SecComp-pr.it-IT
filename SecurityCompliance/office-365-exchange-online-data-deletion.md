...
Il processo per l'azzeramento delle pagine dipende dallo scenario di eliminazione. Nella tabella seguente vengono descritti gli scenari di eliminazione dei database e quando si verificano le funzioni di azzeramento delle pagine.
