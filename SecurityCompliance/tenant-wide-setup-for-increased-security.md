...
|***Autenticazione di posta elettronica*** <br/> |Sì  <br/> |L'autenticazione di posta elettronica utilizza un sistema DNS (Domain Name) per aggiungere informazioni verificabili ai messaggi di posta elettronica relative al mittente di un messaggio di posta elettronica. Office 365 viene configurata l'autenticazione di posta elettronica per il dominio predefinito (onmicrosoft.com), ma gli amministratori di Office 365 possono inoltre utilizzare l'autenticazione di posta elettronica per i domini personalizzati. Vengono utilizzati tre metodi di autenticazione:<br/> <br> &ensp;&ensp;• Sender Policy Framework (o SPF).<br/>&ensp;&ensp;&ensp;&ensp;-Per l'installazione, vedere [impostare SPF in Office 365 per evitare attacchi di spoofing](set-up-spf-in-office-365-to-help-prevent-spoofing.md). <br/> &ensp;&ensp;• DomainKeys identificati posta (DKIM). <br/> &ensp;&ensp;&ensp;&ensp;- [Utilizzare DKIM per la posta elettronica nel dominio personalizzato in Office 365](https://docs.microsoft.com/office365/SecurityCompliance/use-dkim-to-validate-outbound-email), vedere. <br>&ensp;&ensp;&ensp;&ensp;-Dopo aver configurato il DKIM, abilitare la protezione &amp; centro conformità.<br/> &ensp;&ensp;• Autenticazione messaggio basati sul dominio, Reporting e conformità (DMARC). </br> &ensp;&ensp;&ensp;&ensp;-Per DMARC del programma di installazione [Utilizza DMARC per convalidare la posta elettronica in Office 365](use-dmarc-to-validate-email.md).<br/>  <br/>
|
