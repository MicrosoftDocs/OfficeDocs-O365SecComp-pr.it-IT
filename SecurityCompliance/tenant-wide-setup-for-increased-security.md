...
|**Collegamenti sicuri di ATP** <br/> |Sì  <br/> | Aggiungere questa impostazione per il criterio predefinito per l'intera organizzazione:  <br/> • Utilizzare sicuri collegamenti: Office 365 ProPlus, di Office per iOS e Android (Selezionare questa opzione).  <br/> <br>Criteri consigliati per i destinatari specifici:  <br/>  • URL verranno riscritti e confrontati con un elenco di collegamenti dannosi noti quando l'utente fa clic sul collegamento (Selezionare questa opzione).  <br/>  • Utilizzare gli allegati sicuri per analizzare contenuto scaricabile (questa casella di controllo).  <br/>  • Applicato a, ovvero il dominio del destinatario è (selezionare il dominio).  <br/> <br> Ulteriori informazioni: [collegamenti sicuri degli strumenti di analisi di Office 365](atp-safe-links.md).  <br/> |
