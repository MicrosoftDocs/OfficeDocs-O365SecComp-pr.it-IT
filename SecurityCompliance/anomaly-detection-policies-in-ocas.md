...
Come [amministratore globale o sicurezza](permissions-in-the-security-and-compliance-center.md), è possibile esaminare e se necessario, modificare i criteri predefiniti disponibili in Office 365 Cloud App sicurezza.
...
4. Nell'elenco **tipo** selezionare **criterio rilevamento anomalia**.
    
    L'organizzazione predefinita (o esistenti) vengono visualizzati i criteri di rilevamento anomalia.
...
1. Scegliere **indagare** \> **registro attività**.
    
2. Selezionare un elemento, ad esempio un utente o l'indirizzo IP. Verrà aperto il cassetto informazioni pertinenti.
    
    ![Nel Registro di attività, è possibile ricercare un indirizzo IP.](media/32a727c5-e406-4fe2-9443-c1a7fb6628fc.png)
  
3. Nel cassetto rilevanti sui concetti, fare clic su dei comandi disponibili, ad esempio un'icona nell'area **Mostra simili** . 
...
4. Ottenere informazioni sull'elemento selezionato continuando esplorare i dettagli relativi a quell'elemento.
